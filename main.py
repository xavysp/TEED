...
def parse_args():
    ...
    parser.add_argument('--lrs', default=[7e-4,3e-5,1e-6], type=float,
    ...
    parser.add_argument('--version_notes',
                        default=' V10-3 TDC-BIPED AF=Smish -USNet BN+AF  Just xav init normal BDCNloss2+CatsLoss2 CofusionM-WDCplus(return Fsmish())',
                        type=str,
                        help='version notes')
