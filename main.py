...
def parse_args():
    ...
    parser.add_argument('--version_notes',
                        default='V14-l1-300-4 aug0 BIRND+BIPED-trainingdataLoaderSetting AF=tanh+smish+Xaf -USNet---noBN xav init normal bdcnLoss2+cats2loss +DoubleF-DWC-2After AF sum',
                        type=str,
                        help='version notes')
