...
def parse_args():
    ...
    parser.add_argument('--lrs', default=[7e-4,5e-5,1e-5], type=float,
    ...
    parser.add_argument('--version_notes',
                        default=' V7-2 TDC-BIPED AF=Smish -USNet BN+AF  Just xav init normal BDCNloss2+CatsLoss2 CofusionWDCNOsmish+(return Fmish())',
                        type=str,
                        help='version notes')
