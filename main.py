...
def parse_args():
    ...
    parser.add_argument('--lrs', default=[8e-4,5e-5,1e-5], type=float,
                        help='LR for set epochs')
    parser.add_argument('--wd', type=float, default=1e-8, metavar='WD',
    ...
    parser.add_argument('--version_notes',
                        default=' V10-13 TDC-BIPED AF=Smish -USNet BN+AF  Just xav init normal BDCNloss2+CatsLoss2 CofusionWDC2smish+(return Fsmish())',
                        type=str,
                        help='version notes')
