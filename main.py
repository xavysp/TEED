...
def parse_args():
    ...
    parser.add_argument('--version_notes',
                        default='V14-l1-300-5 aug0 BIPED+BRIND-trainingdataLoaderSetting2 AF=smish+Xaf -USNet---noBN xav init normal bdcnLoss2+cats2loss +DoubleF-DWC-3smish AF sum',
                        type=str,
                        help='version notes')
