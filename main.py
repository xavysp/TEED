...
def parse_args():
    ...
    parser.add_argument('--checkpoint_data',
                        type=str,
                        default='20/20_model.pth',# 37 for biped 60 MDBD
    ...
    parser.add_argument('--version_notes',
                        default=' V7-5 TDC-BIPED AF=Smish -USNet BNnoAF  Just xav init normal BDCNloss2+CatsLoss2 CofusionWDCNOsmish+(return Fmish())',
                        type=str,
                        help='version notes')
