...
def parse_args():
    ...
    parser.add_argument('--lr', default=5e5, type=float,
    ...
    parser.add_argument('--version_notes',
                        default=' V11-1 TDC-BIPED AF=Smish -USNet AF  Just xav init normal BDCNloss2+CatsLoss2 CofusionWDCNOsmish+(return Fmish())',
                        type=str,
                        help='version notes')
