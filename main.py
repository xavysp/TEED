...
def parse_args():
    ...
    parser.add_argument('--wd', type=float, default=5e4, metavar='WD',
    ...
    parser.add_argument('--version_notes',
                        default=' V15-7 TED-BIPED BIPED-trainingdataLoaderSetting AF=smish -USNet---noBN xav init normal bdcnLoss2+cats2loss +CofusionDWC2Smish last sum',
                        type=str,
                        help='version notes')
