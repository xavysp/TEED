...
def parse_args():
    ...
    parser.add_argument('--lrs', default=[1e-6,1e-7,1e-5], type=float,
    ...
    parser.add_argument('--version_notes',
                        default=' V12-6 TDC-BIPED AF=Smish -USNet AF  Just xav init normal BDCNloss2+CatsLoss2 CofusionWDCNOsmish+(return Fmish()) NewImean',
                        type=str,
                        help='version notes')
