...
def parse_args():
    ...
    parser.add_argument('--version_notes',
                        default=' V14-6-320-5 TED-BIPED augB3 BRIND+BIPED-trainingdataLoaderSetting AF=smish -USNet---noBN xav init normal bdcnLoss2+cats2loss +DoubleF-DWC-2before1after AF sum',
                        type=str,
                        help='version notes')
