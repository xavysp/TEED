...
def parse_args():
    ...
    parser.add_argument('--lrs', default=[1e-3,5e-5,1e-5], type=float,
    ...
    parser.add_argument('--version_notes',
                        default=' V7-4 TDC-BIPED AF=Smish -USNet BN+AF  Just xav init normal BDCNloss2+CatsLoss2 CofusionWDCNOsmish+(return Fmish())',
                        type=str,
                        help='version notes')
